            ...
            >
              ...
              <span
                className={classNames(
                  ...
                  'ml-auto inline-py-0.5 px-3 text-xs rounded-full',
                )}
              >
                {data.length}
              </span>
              ...
              <div className='flex flex-1'>
                <form className='flex w-full md:ml-0' action='#' method='GET'>
                  ...
                  <div className='relative w-full text-gray-400 focus-within:text-gray-600'>
                    ...
                    <input
                      id='search-field'
                      className='w-full h-full py-2 pl-8 pr-3 text-gray-900 placeholder-gray-500 border-transparent focus:outline-none focus:placeholder-gray-400 focus:ring-0 focus:border-transparent sm:text-sm'
                      placeholder='Search'
                      type='search'
                      name='search'

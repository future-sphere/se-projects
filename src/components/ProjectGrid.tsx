      ...
      {projects.map((project) => (
        ...
        >
          ...
          <div className='flex items-center gap-5 mt-3 font-mono text-xs'>
            ...
            <a
              target={'_blank'}
              href={`https://github.com/future-sphere/se-projects/blob/Deploy-League-of-Legends-app-to-SE-Projects/src/projects/${project.subject}/${project.slug}/index.${project.file_extension}`}
              className='flex items-center gap-1 text-blue-600 hover:text-blue-900'
              rel='noreferrer'
            >
